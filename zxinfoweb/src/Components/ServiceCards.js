  ...
  return (
    <>
      <section class=" bg-blue-500ray-50">
        <div class="py-1  sm:py-16 block lg:py-1 relative bg-opacity-50  z-40  ">
          <div class="relative mx-auto h-full px-4 pb-20  md:pb-10 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8">
            <div class="px-4 max-w-7xl sm:px-6 lg:px-8 relative">
              <div class="grid grid-cols-1  mt-12 sm:grid-cols-3 lg:mt-12 gap-16  ">
                <a
                  href="#"
