  ...
  return (
    <div className=" max-w-[1240px] h-[500px] p-2  mx-auto  mt-[100px]  md:grid grid-cols-2 md:mt-60">
      ...
      <div className=" col-span-1">
        ...
        <button
          type="button"
          className="text-white bg-gradient-to-br ml-2 from-purple-600 to-blue-500 hover:bg-gradient-to-bl  focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"
        >
          Request a Demo
        </button>
      </div>
